# Blog Checkpoint: Woche 1 – Patchwork Familie

**Datum:** 02.03.2026  
**Status:** Woche 1 aktiv

## Heutiger Artikel (02.03.2026)
...
|-------|------------|--------------------------------|------------|
| 1     | 02.03.2026 | Patchwork Familie              | ✅ Heute   |
| 2     | 09.03.2026 | Mama Burnout                   | ⏳ Ausstehend |
...
| 9     | 27.04.2026 | Alleinerziehende Mutter        | ⏳ Ausstehend |
...
## Technische Notizen
- Die Blog-Übersicht filtert Artikel automatisch via `publishedAt <= new Date()` (serverseitig in `getBlogArticles`)
- Artikel mit `status = 'published'` und `publishedAt` in der Vergangenheit werden angezeigt
- Keine manuellen Code-Änderungen erforderlich
